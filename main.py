...
if "current_session" not in st.session_state: #文件名称
...
if shuru:
    ...
    response = client.chat.completions.create(
        model="deepseek-chat",
        messages=[
            {"role": "system", "content": system_promt % (st.session_state.nick_name,st.session_state.nick_experience)},
